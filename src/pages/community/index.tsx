    ...
    <div className='py-16 px-4 space-y-8'>
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <div key={i} className='flex cursor-pointer flex-col items-start'>
          ...
          <div className='flex px-4 space-x-5 text-gray-700 py-2.5 border-t border-b-[2px] w-full'>
      ...
      <button className='fixed bottom-24 right-5 bg-orange-400 rounded-full p-3 text-white p-4 shadow-xl hover:bg-orange-500 transition-colors cursor-pointer'>
        <svg
          className='w-6 h-6'
          fill='none'
          stroke='currentColor'

export default function Home() {
  return (
    <div className='bg-slate-400 xl:place-content-start py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen'>
      <div className='bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl'>
        ...
        <div className='mt-5 bg-blue-500 dark:bg-black dark:border-white dark:border text-white p-3 text-center rounded-xl w-2/4 mx-auto dark:hover:bg-white hover:bg-teal-500 hover:text-black  active:bg-yellow-500 focus:bg-red-500'>
          CheckOut
        </div>
      </div>
        ...
        <div className='flex flex-col'>
          ...
          <div className='mt-3 mb-5 flex justify-between items-center'>
            ...
            <div className='flex items-center space-x-5'>
              <button className='p1.5 rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8  text-xl text-gray-500'>
                -
              </button>
              <span>1</span>
              <button className='p1.5 rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-xl text-gray-500'>
